...
const AdminProductForm = () => {
  ...
  const handleProductImageUpload = (e) => {
    ...
    const reader = new FileReader();
    reader.onloadend = () => {
      const cleanImageString = reader.result.replace(
        /^data:image\/\w+;base64,/,
        ""
      );
      setFormData((prev) => ({
  ...
  return (
    <div className="admin-product-container">
      ...
      {errors.global && (
        <div className="admin-status-message error-message">
          {errors.global}
        </div>
      )}
      {success && (
        <div className="admin-status-message success-message">{success}</div>
      )}
      ...
      <form onSubmit={handleSubmit} className="admin-product-form">
        <div className="admin-form-grid">
          ...
          <div className="admin-input-group">
            ...
            />
            {errors.name && (
              <span className="admin-field-error">{errors.name}</span>
            )}
          </div>
          ...
          <div className="admin-input-group">
            ...
            />
            {errors.brand && (
              <span className="admin-field-error">{errors.brand}</span>
            )}
          </div>
          ...
          <div className="admin-input-group">
            ...
            />
            {errors.stock && (
              <span className="admin-field-error">{errors.stock}</span>
            )}
          </div>
